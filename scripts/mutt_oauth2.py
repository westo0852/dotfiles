...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', os.getenv("EMAIL_ADDRESS")]
...
registrations = {
    'google': {
        ...
        'client_id': os.getenv("NEOMUTT_GOOGLE_CLIENT_ID"),
        'client_secret': os.getenv("NEOMUTT_GOOGLE_CLIENT_SECRET"),
    },
    'microsoft': {
