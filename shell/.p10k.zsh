# Generated by Powerlevel10k configuration wizard on 2025-01-21 at 13:59 AEDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # local      clean='%76F'
      local   modified='%013F'  # purple foreground
      # local   modified='%178F'
      local  untracked='%012F'  # blue foreground
      # local  untracked='%39F'
      local conflicted='%200F'  # red foreground
    else
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=200
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=200
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=200
